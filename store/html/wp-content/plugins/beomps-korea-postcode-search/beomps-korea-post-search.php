<?php
	...
	function bkps_custom_override_checkout_fields( $fields ) {
	      ...
	      $fields['billing']['billing_address_1']['label'] = '<input type="button" id="billing_postcode_search" value="'.$find_button_name_display.'" class="btn" onclick="openDaumPostcode();" style="height: 40px;">';

	      $fields['shipping']['shipping_address_1']['label'] = '<input type="button" id="shipping_postcode_search" value="'.$find_button_name_display.'" class="btn" onclick="openDaumPostcode2();" style="height: 40px;">';
	...
	function bkps_custom_override_billing_fields( $fields ) {
		...
		$fields['billing_address_1']['label'] = '<input type="button" id="billing_postcode_search" value="'.$find_button_name_display.'" class="btn" onclick="openDaumPostcode();" style="height: 40px;">';
  	 	return $fields;
	}
	...
	function bkps_custom_override_shipping_fields( $fields ) {
		...
		$fields['shipping_address_1']['label'] = '<input type="button" id="billing_postcode_search" value="'.$find_button_name_display.'" class="btn" onclick="openDaumPostcode2();" style="height: 40px;">';
  	 	return $fields;
	}
